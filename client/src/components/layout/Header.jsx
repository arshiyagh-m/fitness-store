      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-6 w-full lg:w-2/3">
          <Link to="/" className="flex items-center gap-2 group">
            <div className="bg-dark text-primary p-2 rounded-xl group-hover:bg-primary group-hover:text-dark transition-colors"><Dumbbell size={28} strokeWidth={2.5} /></div>
            <span className="text-2xl font-black tracking-tighter text-dark uppercase">Team 9</span>
          </Link>
          <div className="hidden lg:flex items-center bg-gray-50 rounded-xl w-full max-w-xl px-4 py-2.5 text-gray-600 border border-gray-200 focus-within:border-primary transition-all">
        ...
        <div className="flex items-center gap-4 border-r border-gray-200 pr-4">
          {user ? (
            ...
            <Link to="/login" className="flex items-center gap-2 bg-dark text-white rounded-xl px-5 py-2.5 hover:bg-gray-800 transition-colors shadow-md"><LogIn size={20} className="text-primary" /><span className="text-sm font-bold hidden sm:block">ورود</span></Link>
          )}
